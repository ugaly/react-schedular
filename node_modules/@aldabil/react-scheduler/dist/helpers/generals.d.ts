...
import { DefaultRecourse, FieldProps, ProcessedEvent, ResourceFields, SchedulerProps } from "../Scheduler";
import { StateEvent } from "../views/Editor";
export declare const getOneView: (state: SchedulerProps) => View;
